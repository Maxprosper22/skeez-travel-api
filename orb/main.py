...
from orb.utils.db import db_conn, db_pool
from config import settings
from orb.utils.templating import setupTemplating
# from orb.utils.keys import setupECDSA_Keys
from orb.utils.registry import register_apps
...
def create_app() -> Sanic:
    ...
    async def applicationSetup(app, loop):
        ...
        dsn = await db_conn(config=settings)
