...
from .views import dashboard, AdminAuthView, TripView, view_trips, create_trip, start_trip, end_trip, cancel_trip
...
async def router(bp: Blueprint) -> None:
    ...
    bp.add_route(AdminAuthView.as_view(), '/auth/signin')
